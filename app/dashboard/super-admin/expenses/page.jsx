 ...
 * Uses APIs: api/expense_management.php (GET for fetch, POST for create/update, DELETE for delete), api/branch_management.php
...
import { apiPost, apiDelete, apiGet, getTerminal } from '@/utils/api';
...
export default function ExpenseManagementPage() {
   ...
   * API: api/expense_management.php (GET with branch_id=null for all)
   */
