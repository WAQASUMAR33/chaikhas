...
export default function CreateOrderPage() {
   ...
   * This ensures KOT is printed to all configured kitchen printers
   */
  useEffect(() => {
    if (receiptModalOpen && orderReceipt && orderReceipt.order_id) {
      // Auto-print KOT after a short delay to ensure order is fully created
      const timer = setTimeout(() => {
        console.log('Auto-printing KOT for order:', orderReceipt.order_id);
        handlePrintReceipt();
      }, 800); // Increased delay to ensure backend has processed the order
