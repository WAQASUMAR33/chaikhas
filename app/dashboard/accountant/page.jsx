    ...
    <AccountantLayout>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600">Welcome to your accountant management dashboard</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Total Sales */}
          <div className="bg-green-50 rounded-lg shadow p-6 hover:shadow-lg transition">
            <div className="flex items-center justify-between mb-4">
              <div className="text-green-500 text-3xl font-bold">
                {loading ? '...' : formatPKR(stats.totalSales)}
              </div>
              <div className="text-green-500 bg-white rounded-full p-3">
          ...
          {/* Today Orders */}
          <div className="bg-purple-50 rounded-lg shadow p-6 hover:shadow-lg transition">
            <div className="flex items-center justify-between mb-4">
              <div className="text-purple-500 text-3xl font-bold">
                {loading ? '...' : stats.todayOrders || 0}
              </div>
              <div className="text-purple-500 bg-white rounded-full p-3">
          ...
          {/* Today Sales */}
          <div className="bg-orange-50 rounded-lg shadow p-6 hover:shadow-lg transition">
            <div className="flex items-center justify-between mb-4">
              <div className="text-orange-500 text-3xl font-bold">
                {loading ? '...' : formatPKR(stats.todaySales || 0)}
              </div>
              <div className="text-orange-500 bg-white rounded-full p-3">
                <TrendingUp className="w-6 h-6" />
              </div>
            </div>
            <h3 className="text-sm font-medium text-gray-700">Today's Sales</h3>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <FileText className="w-5 h-5 text-[#FF5F15]" />
              Information
            </h2>
